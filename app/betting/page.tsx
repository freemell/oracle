  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-57px)]">
        {/* Left Sidebar */}
        <aside className="w-full lg:w-64 border-r border-white/20 bg-black/40 backdrop-blur-sm overflow-y-auto order-2 lg:order-1 max-h-[50vh] lg:max-h-none">
          <div className="p-4">
            <div className="mb-6">
        ...
        {/* Main Content */}
        <main className="flex-1 overflow-y-auto order-1 lg:order-2 pb-4 lg:pb-0">
        ...
        <aside className="w-full lg:w-80 border-l border-white/20 bg-black/40 backdrop-blur-sm order-3 max-h-[40vh] lg:max-h-none overflow-y-auto">
          <div className="p-4">
